...
for dataset_name in dataset_names:
    ...
    res_per_instance = analysis_utils.get_ranks_per_instance_time(
        all_result,
        horizon_time,
        number_of_arms,
        instances,
...
#     ax=ax,
# )
# ax.set_title("Methods rank correlation", fontdict={'size': title_size})

# plt.savefig(
#     path+ "ranks_cor_per_dataset.pdf", dpi=600, bbox_inches="tight"
# )
